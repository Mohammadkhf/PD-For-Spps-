function [error_primal, error_dual, gap_function, x_bar, y_bar ] = ALPD_quad_obj_linear_cons(n,m,K,Q,c,A,b,l_yy,l_xy,l_xx,D_x,D_y, l_f, l_g, mu_f,mu_g,x_init,y_init)
x = zeros(n,K+1); 
y = zeros(m,K+1); 
...
for t=1:K
    ...
    cvx_begin quiet  %optiimizaing in dual 
        ...
        %minimize (-y_sol'*v(:,t)+ y_sol'*b+ (mu_g)*y_sol'*y(:,t) +
